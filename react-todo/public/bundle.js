...
/***/ function(module, exports, __webpack_require__) {
    ...
    var Todo = __webpack_require__(213);
...
/***/ function(module, exports, __webpack_require__) {
    ...
    var React = __webpack_require__(1);
    var Router = __webpack_require__(159);
    var AllTodos = __webpack_require__(214);
    var SingleTodo = __webpack_require__(215);
    var NewTodo = __webpack_require__(216);
    ...
    var Todo = React.createClass({
      ...
      componentDidMount: function componentDidMount() {
        ...
        var _this = this;
        Axios.get('http://localhost:10010').then(function (res) {
          _this.setState({ todos: res.data });
        });
      },
      handleAddTodo: function handleAddTodo(newtodo) {
        // post new note to Elasticsearch
        newtodo.todo_id = this.state.todos.length;
        Axios.post('http://localhost:10010', newtodo).then(function (res) {
          console.log(res);
        });
      },
      displayTodo: function displayTodo(todo) {
      ...
      render: function render() {
        return React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'row-md-4' },
            React.createElement(AllTodos, { todos: this.state.todos, displayTodo: this.displayTodo })
          ),
          React.createElement(
            'div',
            { className: 'row-md-4' },
            React.createElement(SingleTodo, { todo: this.state.todo, displayTodo: this.displayTodo })
          ),
          React.createElement(
            'div',
            { className: 'row-md-4' },
            React.createElement(NewTodo, { addTodo: this.handleAddTodo })
          )
        );
      }
    });
...
/***/ function(module, exports, __webpack_require__) {
    ...
    var AllTodos = React.createClass({
      displayName: "AllTodos",

      propTypes: {
        displayTodo: React.PropTypes.func.isRequired
      },
      handleSelect: function handleSelect(todo) {
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  "button",
                  { className: "btn btn-link", type: "button", onClick: _this.handleSelect.bind(_this, todo) },
                  todo.todo
                )
              )
            ),
...
/***/ function(module, exports, __webpack_require__) {
    ...
    var SingleTodo = React.createClass({
      ...
      handleCompleted: function handleCompleted(event) {
        var updatedTodo = this.props.todo;
      ...
      handleUpdate: function handleUpdate() {
        ...
        Axios.put('http://localhost:10010/todo/' + this.props.todo.todo_id, this.props.todo).then(function (res) {
          console.log(res);
        });
      },
      render: function render() {
        return React.createElement(
          ...
          React.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Todo', value: this.props.todo.todo, onChange: this.handleTodoChange }),
          React.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Author', value: this.props.todo.author, onChange: this.handleAuthorChange }),
          React.createElement('input', { type: 'datetime', className: 'form-control', placeholder: 'Due Date', value: this.props.todo.duedate, onChange: this.handleDateChange }),
          React.createElement('input', { type: 'checkbox', className: 'form-control', checked: this.props.todo.completed, onChange: this.handleCompleted }),
          React.createElement(
            'button',
            { className: 'btn btn-default', type: 'button', onClick: this.handleUpdate },
            'Save'
          )
        );
      }
...
/***/ function(module, exports, __webpack_require__) {
    ...
    var React = __webpack_require__(1);
    var AddTodo = __webpack_require__(217);
    ...
    var NewTodo = React.createClass({
      ...
      render: function render() {
        return React.createElement(
          ...
          React.createElement(AddTodo, { addTodo: this.props.addTodo })
        );
      }
    });
...
/***/ function(module, exports, __webpack_require__) {
    ...
    var AddTodo = React.createClass({
      ...
      handleAuthor: function handleAuthor(event) {
        newTodo.author = event.target.value;
      },
      handleDate: function handleDate(event) {
      ...
      render: function render() {
        return React.createElement(
          'div',
          { className: 'input-group' },
          React.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Add New Todo', onChange: this.handleTodo }),
          React.createElement('input', { type: 'text', className: 'form-control', placeholder: 'Author', onChange: this.handleAuthor }),
          React.createElement('input', { type: 'date', className: 'form-control', onChange: this.handleDate }),
          React.createElement(
            'span',
            { className: 'input-group-btn' },
            React.createElement(
